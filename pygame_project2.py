...
#배경 이미지 불러오기
background = pygame.image.load("C:/Users/YEONWOO/AppData/Local/Temp/Temp1_PYGAME~1.ZIP/PyGameProject_KUCC/images/background.png")
background_size = background.get_rect().size #이미지 크기
background_width = background_size[0]
backgroud_height = background_size[1]
...
#캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/YEONWOO/AppData/Local/Temp/Temp1_PYGAME~1.ZIP/PyGameProject_KUCC/images/plane.png")
...
#장애물 캐릭터
enemy = pygame.image.load("C:/Users/YEONWOO/AppData/Local/Temp/Temp1_PYGAME~1.ZIP/PyGameProject_KUCC/images/enemy.png")
...
while running:
    dt = clock.tick(1000) #게임화면의 초당 프레임 수
